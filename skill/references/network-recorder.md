...
Script: `.agents/skills/vibe-browser/scripts/record-network.ts`
...
bun .agents/skills/vibe-browser/scripts/record-network.ts <targetId> network-events.jsonl 30000

# HTTP only
INCLUDE_WS=0 HTTP_ONLY=1 bun .agents/skills/vibe-browser/scripts/record-network.ts <targetId> network-requests.jsonl 20000

# WS only, and only sockets containing "gmgn.ai"
INCLUDE_HTTP=0 URL_INCLUDES=gmgn.ai bun .agents/skills/vibe-browser/scripts/record-network.ts <targetId> ws.jsonl 20000
```
